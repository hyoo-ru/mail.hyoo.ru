...
var $;
(function ($) {
    class $hyoo_mail extends $.$mol_book2 {
        plugins() {
            return [
                this.Theme()
            ];
        ...
        Folder_page(id) {
            ...
            obj.body = () => [
                this.Folder_mails(id)
            ];
            return obj;
        }
        Mail_page(id) {
            const obj = new this.$.$mol_page();
            obj.title = () => this.mail_subject(id);
            obj.tools = () => [
                this.Mail_close()
            ];
            obj.body = () => [
        ...
        Folder_link(id) {
            ...
            obj.title = () => this.folder_title(id);
            obj.arg = () => this.folder_arg(id);
            return obj;
        }
        Mail_link(id) {
            const obj = new this.$.$mol_link();
            obj.title = () => this.mail_subject(id);
            obj.arg = () => this.mail_arg(id);
            return obj;
        }
        Theme() {
        ...
        Source_link() {
            ...
            obj.uri = () => "https://github.com/hyoo-ru/mail.hyoo.ru";
            return obj;
        }
        Lights() {
        ...
        Reply_send() {
            ...
            obj.title = () => "Send";
            obj.enabled = () => this.mail_sen_enabled();
            return obj;
        }
        Reply() {
            const obj = new this.$.$mol_row();
    ...
    __decorate([
        $.$mol_mem_key
    ], $hyoo_mail.prototype, "Folder_page", null);
    __decorate([
        $.$mol_mem_key
    ], $hyoo_mail.prototype, "Mail_page", null);
    __decorate([
        $.$mol_mem_key
    ], $hyoo_mail.prototype, "Folder_link", null);
    __decorate([
        $.$mol_mem_key
    ], $hyoo_mail.prototype, "Mail_link", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_mail.prototype, "Theme", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_mail.prototype, "Source_link", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_mail.prototype, "Lights", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_mail.prototype, "Folders_links", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_mail.prototype, "Folders", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_mail.prototype, "Folder_close_icon", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_mail.prototype, "Folder_close", null);
    __decorate([
        $.$mol_mem_key
    ], $hyoo_mail.prototype, "Folder_mails", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_mail.prototype, "Mail_close_icon", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_mail.prototype, "Mail_close", null);
    __decorate([
        $.$mol_mem_key
    ], $hyoo_mail.prototype, "Mail_from", null);
    __decorate([
        $.$mol_mem_key
    ], $hyoo_mail.prototype, "Mail_to", null);
    __decorate([
        $.$mol_mem_key
    ], $hyoo_mail.prototype, "Mail_copy", null);
    __decorate([
        $.$mol_mem_key
    ], $hyoo_mail.prototype, "Mail_head", null);
    __decorate([
        $.$mol_mem_key
    ], $hyoo_mail.prototype, "Mail_body", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_mail.prototype, "Reply_message", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_mail.prototype, "Reply_send", null);
    __decorate([
        $.$mol_mem
    ], $hyoo_mail.prototype, "Reply", null);
    $.$hyoo_mail = $hyoo_mail;
})($ || ($ = {}));
//mail.view.tree.js.map
;
"use strict";
//value.js.map
;
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $.$mol_mem
        ], $hyoo_mail.prototype, "data", null);
        __decorate([
            $.$mol_mem
        ], $hyoo_mail.prototype, "pages", null);
        __decorate([
            $.$mol_mem
        ], $hyoo_mail.prototype, "folders_links", null);
        __decorate([
...
(function ($_1) {
    $_1.$mol_test({
        'atoms'($) {
            $_1.$mol_assert_equal($.$mol_tree2_to_json($.$mol_tree2_from_string("null\n").kids[0]), null);
            $_1.$mol_assert_equal($.$mol_tree2_to_json($.$mol_tree2_from_string("true\n").kids[0]), true);
            $_1.$mol_assert_equal($.$mol_tree2_to_json($.$mol_tree2_from_string("false\n").kids[0]), false);
        },
        'numbers'($) {
            $_1.$mol_assert_equal($.$mol_tree2_to_json($.$mol_tree2_from_string("1\n").kids[0]), 1);
            $_1.$mol_assert_equal($.$mol_tree2_to_json($.$mol_tree2_from_string("1.2\n").kids[0]), 1.2);
            $_1.$mol_assert_equal($.$mol_tree2_to_json($.$mol_tree2_from_string("1.2e+2\n").kids[0]), 120);
            $_1.$mol_assert_equal($.$mol_tree2_to_json($.$mol_tree2_from_string("NaN\n").kids[0]), Number.NaN);
            $_1.$mol_assert_equal($.$mol_tree2_to_json($.$mol_tree2_from_string("+Infinity\n").kids[0]), Number.POSITIVE_INFINITY);
            $_1.$mol_assert_equal($.$mol_tree2_to_json($.$mol_tree2_from_string("-Infinity\n").kids[0]), Number.NEGATIVE_INFINITY);
        },
        'string'($) {
            $_1.$mol_assert_equal($.$mol_tree2_to_json($.$mol_tree2_from_string("\\foo\n").kids[0]), 'foo');
            $_1.$mol_assert_equal($.$mol_tree2_to_json($.$mol_tree2_from_string("\\\n\t\\foo\n\t\\bar\n").kids[0]), 'foo\nbar');
        },
        'array'($) {
            $_1.$mol_assert_like($.$mol_tree2_to_json($.$mol_tree2_from_string("/\n").kids[0]), []);
            $_1.$mol_assert_like($.$mol_tree2_to_json($.$mol_tree2_from_string("/\n\t\\foo\n\t\\bar\n").kids[0]), ['foo', 'bar']);
            $_1.$mol_assert_like($.$mol_tree2_to_json($.$mol_tree2_from_string("/\n\t- \\foo\n\t\\bar\n").kids[0]), ['bar']);
        },
        'object'($) {
