...
;
	($.$hyoo_mail) = class $hyoo_mail extends ($.$mol_book2) {
		plugins(){
			return [(this.Theme())];
		}
		pages(){
		...
		Folder_page(id){
			...
			(obj.tools) = () => ([(this.Folder_close())]);
			(obj.body) = () => ([(this.Folder_mails(id))]);
			return obj;
		}
		Mail_page(id){
			const obj = new this.$.$mol_page();
			(obj.title) = () => ((this.mail_subject(id)));
			(obj.tools) = () => ([(this.Mail_close())]);
			(obj.body) = () => ([
				(this.Mail_head(id)), 
				(this.Mail_body(id)), 
				(this.Reply())
		...
		Folder_close(){
			const obj = new this.$.$mol_link();
			(obj.arg) = () => ({"folder": null, "mail": null});
			(obj.sub) = () => ([(this.Folder_close_icon())]);
			return obj;
		}
		folder_mails(id){
			return [];
		...
		Reply(){
			const obj = new this.$.$mol_row();
			(obj.sub) = () => ([(this.Reply_message()), (this.Reply_send())]);
			return obj;
		}
		folder_arg(id){
			return {};
	...
	($mol_mem_key(($.$hyoo_mail.prototype), "Folder_page"));
	($mol_mem_key(($.$hyoo_mail.prototype), "Mail_page"));
	($mol_mem_key(($.$hyoo_mail.prototype), "Folder_link"));
	($mol_mem_key(($.$hyoo_mail.prototype), "Mail_link"));
	($mol_mem(($.$hyoo_mail.prototype), "Theme"));
	($mol_mem(($.$hyoo_mail.prototype), "Source_link"));
	($mol_mem(($.$hyoo_mail.prototype), "Lights"));
	($mol_mem(($.$hyoo_mail.prototype), "Folders_links"));
	($mol_mem(($.$hyoo_mail.prototype), "Folders"));
	($mol_mem(($.$hyoo_mail.prototype), "Folder_close_icon"));
	($mol_mem(($.$hyoo_mail.prototype), "Folder_close"));
	($mol_mem_key(($.$hyoo_mail.prototype), "Folder_mails"));
	($mol_mem(($.$hyoo_mail.prototype), "Mail_close_icon"));
	($mol_mem(($.$hyoo_mail.prototype), "Mail_close"));
	($mol_mem_key(($.$hyoo_mail.prototype), "Mail_from"));
	($mol_mem_key(($.$hyoo_mail.prototype), "Mail_to"));
	($mol_mem_key(($.$hyoo_mail.prototype), "Mail_copy"));
	($mol_mem_key(($.$hyoo_mail.prototype), "Mail_head"));
	($mol_mem_key(($.$hyoo_mail.prototype), "Mail_body"));
	($mol_mem(($.$hyoo_mail.prototype), "Reply_message"));
	($mol_mem(($.$hyoo_mail.prototype), "Reply_send"));
	($mol_mem(($.$hyoo_mail.prototype), "Reply"));
